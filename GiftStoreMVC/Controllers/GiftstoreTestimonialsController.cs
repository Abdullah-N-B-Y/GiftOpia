...
namespace GiftStoreMVC.Controllers
{
    public class GiftstoreTestimonialsController : Controller
    {
        ...
        public GiftstoreTestimonialsController(ModelContext context)
        {
            _context = context;
        }
        ...
        {
            var modelContext = _context.GiftstoreTestimonials.Include(g => g.User);
        ...
        public async Task<IActionResult> Details(decimal? id)
        {
            ...
            var giftstoreTestimonial = await _context.GiftstoreTestimonials
                .Include(g => g.User)
        ...
        {
            var modelContext = _context.GiftstoreTestimonials.Include(t => t.User);
            return View(await modelContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Edit(decimal? id)
        {
            ...
            var giftstoreTestimonial = await _context.GiftstoreTestimonials.FindAsync(id);
            if (giftstoreTestimonial == null)
            {
                return NotFound();
            }
        ...
        private bool GiftstoreTestimonialExists(decimal id)
        {
          return (_context.GiftstoreTestimonials?.Any(e => e.Testimonialid == id)).GetValueOrDefault();
        }
    }
}
