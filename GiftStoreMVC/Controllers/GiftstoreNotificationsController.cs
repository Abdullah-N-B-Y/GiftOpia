...
public class GiftstoreNotificationsController : Controller
{
    ...
    public GiftstoreNotificationsController(ModelContext context) => _context = context;
    ...
    public async Task<IActionResult> Details(decimal? id)
    {
        ...
        GiftstoreNotification? giftstoreNotification = await _context.GiftstoreNotifications
            .Include(g => g.User)
    ...
    private bool GiftstoreNotificationExists(decimal id) => (_context.GiftstoreNotifications?.Any(e => e.Notificationlid == id)).GetValueOrDefault();
}