...
public class GiftController : Controller
{
    ...
    public GiftController(ModelContext context) => _context = context;
    ...
    public async Task<IActionResult> Index()
    {
        ...
        IIncludableQueryable<GiftstoreGift, GiftstoreOrder>? modelContext = _context.GiftstoreGifts.Include(g => g.Category).Include(g => g.Order);
