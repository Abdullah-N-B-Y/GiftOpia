...
namespace GiftStoreMVC.Controllers
{
    public class GiftstoreBankcardsController : Controller
    {
        ...
        public GiftstoreBankcardsController(ModelContext context)
        {
            _context = context;
        }
        ...
        {
              return _context.GiftstoreBankcards != null ? 
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var giftstoreBankcard = await _context.GiftstoreBankcards
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            var giftstoreBankcard = await _context.GiftstoreBankcards.FindAsync(id);
            if (giftstoreBankcard == null)
            {
                return NotFound();
            }
        ...
        private bool GiftstoreBankcardExists(string id)
        {
          return (_context.GiftstoreBankcards?.Any(e => e.Cardnumber == id)).GetValueOrDefault();
        }
    }
}
